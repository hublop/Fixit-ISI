...
namespace Fixit.Application.Contractors.Events.CancelSubscription
{
  public class SubscriptionCancelledIntegrationEventHandler: IIntegrationEventHandler<SubscriptionCancelledIntegrationEvent>
  {
    ...
    public async Task Handle(SubscriptionCancelledIntegrationEvent @event)
    {
      ...
      var subscriptionStatus =
        await _dbContext.SubscriptionStatuses.SingleAsync(x => x.Status.Equals(SubscriptionStatus.Cancelled));
